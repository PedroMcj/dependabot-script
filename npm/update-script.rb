...
# Package Manager for the project (should be 'npm_and_yarn')
...
##############################
parser = Dependabot::NpmAndYarn::FileParser.new(dependency_files: dep_files, source: source, repo_contents_path: get_simplified_name(project_path))
...
dependencies.select(&:top_level?).each do |dep|
  ...
  checker_class = Dependabot::NpmAndYarn::UpdateChecker::LatestVersionFinder  # TODO: review this
...
#####################################
updater_class = Dependabot::NpmAndYarn::FileUpdater::NpmLockfileUpdater
...
namer = Dependabot::PullRequestCreator::BranchNamer.new(
  dependencies: updated_deps_res,
  files: updater.updated_lockfile,    # TODO: review this
